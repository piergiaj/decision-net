...
if __name__ == '__main__':
    ...
    for ind in [1,2,3,4]: # for each of the 4 cases, load the seat network
        ...
        exp_plot(np.asarray(knowledge), np.asarray(no_knowledge), np.asarray(complexity, dtype='float64'), np.asarray(utility), ind)
    ...
    exp_full_scatter(np.asarray(total_knowledge), np.asarray(total_complexity, dtype='float64'), np.asarray(total_utility))
